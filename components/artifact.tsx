...
function PureArtifact({
	...
	// biome-ignore lint/suspicious/noExplicitAny: Metadata type varies by artifact kind and SWR mutator has different signature
	const setMetadataCompat = setMetadata as any
		...
		if (artifact.documentId !== "init") {
			if (artifactDefinition.initialize) {
				artifactDefinition.initialize({
					...
					setMetadata: setMetadataCompat
				})
			}
		}
	}, [artifact.documentId, artifactDefinition, setMetadataCompat])
							...
							<div className="flex flex-row gap-4 items-start">
								...
								<div className="flex flex-col">
									...
									{isContentDirty ? (
										...
										<div className="w-32 h-3 mt-2 bg-muted-foreground/20 rounded-3xl animate-pulse" />
									)}
								</div>
							</div>
